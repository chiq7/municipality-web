      ...
      <main className="max-w-3xl mx-auto px-4 pb-12 space-y-4">
        ...
        <Section title="① 施設基本情報">
          ...
          <div className="flex flex-wrap items-center gap-2 mb-3">
            <span className="inline-block text-xs bg-gray-100 text-gray-700 px-3 py-1 rounded-full">
              🏷 {f.facilityType}
            </span>
          ...
          {/* 情報出典 */}
          <div className="mt-4 p-3 bg-blue-50 rounded-lg text-xs text-blue-800 space-y-0.5">
            <p>
        ...
        <Section title="③ PDFから読み取れた情報">
          ...
          {/* 抜粋 */}
          <div className="mb-4">
            <p className="text-xs text-gray-500 mb-2">該当箇所の抜粋（PDF原文そのまま）</p>
            {f.excerpt ? (
              <blockquote className="text-sm text-gray-800 bg-gray-50 rounded-lg p-3 border-l-4 border-gray-300 leading-relaxed">
                {f.excerpt}
              </blockquote>
            ) : (
          ...
          {subsidies.length === 0 ? (
            ...
            <div className="space-y-3">
              <p className="text-xs text-amber-700 bg-amber-50 rounded p-2">
                以下はPDF記載・公式情報に基づく補助金です。必ず各省庁の最新情報をご確認ください。
              </p>
              {subsidies.map((s, i) => (
